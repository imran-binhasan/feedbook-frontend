      ...
      <div className="relative z-10 mx-4 w-full max-w-lg rounded-xl bg-card p-6 shadow-2xl">
        <div className="mb-5 flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={onClose}
            className="flex size-8 items-center justify-center rounded-full text-muted-foreground transition-colors hover:bg-surface-muted"
          >
        ...
        {showExistingImage && (
          <div className="relative mb-3">
            ...
            <button
              ...
              className="absolute top-2 right-2 flex size-7 items-center justify-center rounded-full bg-black/60 text-xs text-white hover:bg-black/80"
            >
        ...
        <div className="flex items-center justify-between rounded-lg bg-surface-muted px-4 py-3">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-md px-3 py-1.5 text-sm text-muted-foreground transition-colors hover:bg-card hover:text-primary"
            >
        ...
        <div className="mt-5 flex items-center justify-end gap-3">
          <button
            ...
            className="inline-flex h-10 items-center justify-center rounded-md border border-border-soft bg-card px-4 text-sm font-medium text-foreground transition-colors hover:bg-surface-muted disabled:pointer-events-none disabled:opacity-50"
          >
            Cancel
          </button>
          <button
