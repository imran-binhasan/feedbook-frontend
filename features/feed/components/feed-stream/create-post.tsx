    ...
    <form onSubmit={handleSubmit} className="mb-4 rounded-md bg-card px-4 pt-4 pb-4 sm:px-6 sm:pt-6 sm:pb-6">
      ...
      {preview && (
        <div className="relative mt-4 inline-block pl-15">
          ...
          <button
            ...
            className="absolute top-0 right-0 flex size-6 items-center justify-center rounded-full bg-destructive text-xs text-white"
          >
            ✕
          </button>
        </div>
      ...
      <div className="mt-4 flex items-center justify-between bg-accent-tint px-1.5 py-1.5 sm:px-4 sm:py-2">
        <div className="flex items-center gap-0.5 sm:gap-2">
          ...
          <div>
            <button type="button" onClick={() => fileRef.current?.click()} className="flex items-center gap-1 px-1.5 py-1.5 text-sm text-muted-foreground transition-colors hover:text-primary sm:px-2.5 sm:text-base">
          ...
          <div>
            <button type="button" className="flex items-center gap-1 px-1.5 py-1.5 text-sm text-muted-foreground transition-colors hover:text-primary sm:px-2.5 sm:text-base">
              <span className="bg-card flex size-8.5 shrink-0 items-center justify-center rounded-full transition-colors group-hover:bg-accent">
          ...
          <div>
            <button type="button" className="group flex items-center gap-1.5 px-3 py-1.5 text-sm text-muted-foreground transition-colors hover:bg-surface-muted">
        ...
        <button
          ...
          disabled={createPost.isPending || (!form.text.trim() && !form.image)}
            className={cn(
              "flex shrink-0 items-center gap-1 sm:gap-2 rounded-md px-6 py-3 text-sm font-medium text-white transition-colors",
