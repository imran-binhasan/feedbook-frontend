...
export function CreatePost() {
  ...
  return (
    <div className="mb-4 rounded-md bg-card px-4 pt-4 pb-4 sm:px-6 sm:pt-6 sm:pb-6">
      <div className="flex items-start gap-2 sm:gap-3">
        <Avatar name="Dylan Field" email="dylan@example.com" size={34} className="mt-1" />
      ...
      {preview && (
        <div className="relative mt-4 inline-block pl-[60px]">
        ...
        <div className="flex items-center gap-0.5 sm:gap-2">
          ...
          <div>
            <button type="button" onClick={() => fileRef.current?.click()} className="flex items-center gap-1 px-1.5 py-1.5 text-sm text-muted-foreground transition-colors hover:text-primary sm:px-2.5 sm:text-base">
              <span className="bg-card flex size-[34px] shrink-0 items-center justify-center rounded-full transition-colors group-hover:bg-accent">
